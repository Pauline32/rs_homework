...
cat_cols = ['sexo', 'ind_actividad_cliente', 'segmento', 'ind_nuevo','tiprel_1mes','indext']
...
if __name__ == "__main__":
    ...
    data_date = [ '2016-04-28', '2016-03-28', '2016-02-28', '2016-01-28','2015-12-28']
    ...
    test_id = np.array(pd.read_csv( 'test.csv', usecols = ['ncodpers'])['ncodpers'])
